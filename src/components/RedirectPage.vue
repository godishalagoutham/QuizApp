<template>
  <div class="login-container">
    <div class="login-card">
        ...
        <p class="subtitle">Please login to access quiz!</p>
        <button class="redirect-btn" @click="redirectToLogin">Go to Login Page</button>
    </div>
  </div>
</template>
...
/* Existing styles for the Google button */
.redirect-btn {
